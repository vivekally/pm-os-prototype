  ...
  return (
    <div>
      <PageHead
        ...
        sub="Typed edges connect people, themes, artifacts and decisions. The graph wires itself as knowledge lands."
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-xs text-slate-400">
        ...
        <span className="ml-auto text-slate-500">
          Edge types: causes · informs · owns_risk · led_to · produced · experiences
        </span>
      </div>
    </div>
  );
