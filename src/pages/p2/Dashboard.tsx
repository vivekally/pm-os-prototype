    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
            ...
            {memories.map((m) => (
              <div key={m.id} className="glass glass-hover px-5 py-4">
                <div className="flex items-center gap-2">
                  ...
                  <Badge tone={m.provenance === "documented" ? "green" : "slate"}>
                    {m.provenance}
                  </Badge>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-4 rounded-2xl border border-violet-400/20 bg-violet-500/5 p-4 text-xs leading-relaxed text-slate-400">
