...
export default function Setup() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 flex items-center justify-between rounded-2xl border border-cyan-400/20 bg-cyan-500/5 px-5 py-4 text-sm">
        <span className="text-slate-300">
          Context written once. Every skill reads it automatically.
        </span>
        <Link
          to="/phase-1/skills"
          className="rounded-lg bg-gradient-to-r from-violet-500 to-cyan-500 px-4 py-2 font-semibold text-white"
        >
          Browse skills →
        </Link>
      </div>
